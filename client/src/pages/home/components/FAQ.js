...
export default function FAQ() {
  ...
  const questions = [
    { topic: 'general', question:  t("homepage.FAQ_General_1_title"), answer: t("homepage.FAQ_General_1_description") },
    { topic: 'general', question:  t("homepage.FAQ_General_2_title"), answer: t("homepage.FAQ_General_2_description")},
    { topic: 'general', question:  t("homepage.FAQ_General_3_title"), answer: t("homepage.FAQ_General_3_description") },
    { topic: 'general', question:  t("homepage.FAQ_General_4_title"), answer: t("homepage.FAQ_General_4_description")},
    { topic: 'ourService', question:  t("homepage.FAQ_Technolgy_1_title"), answer: t("homepage.FAQ_Technolgy_1_description")  },
    { topic: 'ourService',  question:  t("homepage.FAQ_Technolgy_2_title"), answer: t("homepage.FAQ_Technolgy_2_description")  },
    { topic: 'ourService',  question:  t("homepage.FAQ_Technolgy_3_title"), answer: t("homepage.FAQ_Technolgy_3_description")  },
    { topic: 'onboarding', question:  t("homepage.FAQ_Platform_1_title"), answer: t("homepage.FAQ_Platform_1_description")  },
    { topic: 'onboarding', question:  t("homepage.FAQ_Platform_2_title"), answer: t("homepage.FAQ_Platform_2_description")  },
    { topic: 'onboarding', question:  t("homepage.FAQ_Platform_3_title"), answer: t("homepage.FAQ_Platform_3_description")  },
    { topic: 'onboarding', question:  t("homepage.FAQ_Platform_4_title"), answer: t("homepage.FAQ_Platform_4_description")  },
  ];
