        ...
        <div className="flex items-center">
          <div>
            ...
            <p className="mt-6 sm:text-left">
              Our mission is to achieve a more cost-efficient and
              environmentally friendly way of waste collection. We want to make
              a positive contribution to improving waste management and
