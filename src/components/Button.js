...
const Button = ({ text, width, arrow, href, margin }) => {
    return (
        <button className={`w-${width ? width : "fit"} ${margin ? margin : "mt-10"} p-0 rounded-lg bg-gradient font-bold text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white transform active:scale-90 transition-transform`}>
